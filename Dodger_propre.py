...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load("heli-1.png").convert()     #pygame.Surface((50,50))
...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect.y = random.randrange(self.rect.height,WINDOWHEIGHT/2)
...
for i in range(3):          #Nombre de mobs visibles à l'écran en même temps
    m = Mob()
    all_sprites.add(m)
    mobs.add(m)
